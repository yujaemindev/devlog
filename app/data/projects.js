const projectsData = [
  {
    title: "DeepInspector · 시설물 AI 안전진단 SaaS",
    period: "2024.10 - 현재",
    role: "웹서비스 팀장 / Backend 중심 Full-Stack",
    description: "교량·터널·댐·지하철 애자 등 다양한 시설물의 데이터 업로드부터 전처리, AI 진단, 결함 측정, 외관조사망도, 상태평가보고서까지 연결하는 SaaS 플랫폼 개발.",
  ...
  },
  {
    ...
    description: "영상 Frame 추출, 입·출구 탐색, J-Tag, 수평·수직 Panorama, 균열 검출·연결·측정, LCR/Global 좌표 변환 및 외관조사망도 생성 Pipeline 개발. 대량 AI 작업 안정성 개선.",
  ...
  },
  {
    ...
    period: "2021 - 2024",
    role: "창업 / 개발총괄",
    description: "K-패션 브랜드의 룩북·상품을 국내외 바이어와 연결하는 B2B 커머스 플랫폼을 창업해 웹·앱·관리자·Backend·인프라를 설계하고 운영. 주문·결제·배송, 검색·추천, 상품연동 등 핵심 도메인 구축.",
  ...
  },
  {
    ...
    description: "Vue.js 사용자 서비스를 Android WebView·iOS WKWebView 앱으로 제공하고 Native-Web Bridge, Push Token, Deep Link, Cookie/Session, 이미지 선택 및 외부 브라우저 연동 구현.",
  ...
  },
  {
    ...
    description: "마이데이터 기반 보험 리모델링 고객앱·설계사앱 개발. 초기 아이디어와 서비스 설계부터 Spring Boot Backend, React Native 앱, Jenkins 배포 및 제품 출시까지 참여.",
  ...
  {
    title: "Knox Portal 관리자 · 삼성 그룹웨어",
    period: "2015 - 2020",
    role: "Enterprise Web Developer",
    description: "삼성 그룹웨어 관리자 시스템 개발·운영. Spring 3→4, Java 1.6→1.8 마이그레이션, 관리자 권한/정책 DB 설계, 중복 코드 모듈화 및 AngularJS 화면 성능 개선.",
    tech1: "Java · Spring",
    tech2: "AngularJS",
  ...
  },
  {
    ...
    description: "국내외 전자제품 후기·기사·댓글을 수집하는 크롤러 통합과 Rule-based 수집 시스템 개발. MySQL DB 설계, Linux Cron 및 Elasticsearch 기반 데이터 처리 경험.",
