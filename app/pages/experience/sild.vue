...
const steps = [
  {
    id: 'overview', label: '개요', title: 'AWS 기반 서비스 운영 구조',
  ...
  {
    id: 'integration', label: '통합 서버', title: '계층형 API 서버와 롤링 배포',
  ...
  {
    id: 'admin', label: '사용자·관리자 화면', title: 'Vue 3 기반 사용자 웹과 관리자 페이지',
  ...
  {
    id: 'recommend', label: '상품 추천', title: '상품 정보 기반 추천과 카테고리 분류',
  ...
  {
    id: 'architecture', label: '시스템 구조', title: '서비스 역할과 배포 흐름을 연결하는 아키텍처',
